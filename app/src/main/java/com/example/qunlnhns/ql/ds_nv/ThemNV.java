...
public class ThemNV extends AppCompatActivity {
    ...
    private EditText edtMaNv, edtHoTen, edtQueQuan, edtDiaChi, edtChucVu, edtSdt;
    private TextView tvNgaySinh, tvGioiTinh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvNgaySinh.setOnClickListener(v -> showDatePickerDialog(ThemNV.this, calendar));
